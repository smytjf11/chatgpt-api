...
* Forked from taranjeet's chatgpt-api. Adding support for it to use Text to Speech and Speech to Text via a docker container
* Code changes largely generated by ChatGPT
